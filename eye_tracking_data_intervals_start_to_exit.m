...
%
%
% Uploading and analysing eye-tracking fixation data
%
% NOTE: AOI numbers are different to the ones used in the EEG analysis code
% 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
filename{1} = 'AOI_total_fixation_duration_intervals_start_to_exit'; %Excel file, created from Tobii export,includes zeros
filename{2} = 'AOI_total_fixation_count_intervals_start_to_exit.xlsx';
...
all_dresses_fixation_duration_time1(L) = new_raw1{x,y}; % vector of all participants fixation durations on all dresses
...
clearvars -except participant all_dresses_fixation_duration_time1 all_dresses_fixation_count
