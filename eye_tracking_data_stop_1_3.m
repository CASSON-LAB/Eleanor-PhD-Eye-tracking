...
filename{1} = 'AOI_total_fixation_duration_stop_1&3.xlsx'; %Excel file, created from Tobii export,includes zeros
filename{2} = 'AOI_total_fixation_count_stop_1&3.xlsx';
...
new_raw1 = raw1(3:28,3:32); %cutting out the text
new_raw2 = raw2(3:28,3:32);
...
filename{7} = 'all_dress_AOIs.xlsx'; %excel file with participant number and chosen dress AOI numbers
