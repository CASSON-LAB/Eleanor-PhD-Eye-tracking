...
filename{1} = 'AOI_total_fixation_duration_intervals_end_to_exit'; %Excel file, created from Tobii export,includes zeros
filename{2} = 'AOI_total_fixation_count_intervals_end_to_exit.xlsx';
...
all_dresses_fixation_duration_time3(L) = new_raw1{x,y}; % vector of all participants fixation durations on all dresses
...
clearvars -except participant all_dresses_fixation_duration_time3 all_dresses_fixation_count
