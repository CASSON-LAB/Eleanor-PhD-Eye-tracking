...
filename{1} = 'AOI_total_fixation_duration_stop_2&4.xlsx'; %Excel file, created from Tobii export,includes zeros
filename{2} = 'AOI_total_fixation_count_stop_2&4.xlsx';
